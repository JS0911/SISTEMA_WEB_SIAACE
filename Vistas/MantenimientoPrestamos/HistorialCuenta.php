...
$permisosError = $permisosHistorial->get_Permisos_Usuarios($id_rol, $id_objeto_Error);
$permisosEstados = $permisosHistorial->get_Permisos_Usuarios($id_rol, $id_objeto_Estados);
$permisosHistorialContrasenia = $permisosHistorial->get_Permisos_Usuarios($id_rol, $id_objeto_Historial);
                    ...
                    <div class="nav">
                        ...
                        if (!empty($permisos1) && $permisos1[0]['PERMISOS_CONSULTAR'] == 1) {
                            ...
                            if (!empty($permisos1) && $permisos1[0]['PERMISOS_CONSULTAR'] == 1) {
                                ...
                                if (!empty($permisosHistorialContrasenia) && $permisosHistorialContrasenia[0]['PERMISOS_CONSULTAR'] == 1) {
