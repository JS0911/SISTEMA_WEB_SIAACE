...
class Historial extends Conectar
{
    public function get_historial() 
    {
        ...
        parent::set_names();
        $sql = "SELECT H.CONTRASENA, U.USUARIO, H.FECHA_MODIFICACION FROM tbl_ms_historial_contrasena as H join tbl_ms_usuario as U on H.ID_USUARIO = U.ID_USUARIO;";
    ...
    public function insert_historial($CONTRASENA, $ID_USUARIO, $FECHA_MODIFICACION)
    {
        try
        {
            $conectar = parent::Conexion();
            parent::set_names();
            $sql = "INSERT INTO `tbl_ms_historial_contrasena` (`CONTRASENA`, `ID_USUARIO`, `FECHA_MODIFICACION`) VALUES (:CONTRASENA, :ID_USUARIO, :FECHA_MODIFICACION)";
