                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                        ...
                                        <div class="form-group"><label class="small mb-1" for="inputUser">Usuario</label><input class="form-control py-4" id="inputUser" name="usuario" type="text" maxlength="15" placeholder="Ingrese su usuario:" 
                                            required pattern="^[A-Za-z]+$" title="Ingrese solo letras (sin números ni caracteres especiales)" required pattern="^\S.*$" title="No se permiten espacios en blanco al principio." oninput="this.value = this.value.toUpperCase()"/></div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[\W_]).{8,}$" title="La contraseña debe contener al menos 8 caracteres, incluyendo al menos una letra mayúscula, una letra minúscula, un número y un carácter especial" required/></div>
                                            </div>
                                            <div class="col-md-6">
